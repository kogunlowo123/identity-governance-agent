"""Identity Governance Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Identity Governance Agent through a multi-step pipeline.
