"""Identity Governance Agent - Domain-Specific Connectors."""
...
class SiemConnectorConnector:
    """Domain-specific connector for siem connector integration with Identity Governance Agent."""
...
class EdrConnectorConnector:
    """Domain-specific connector for edr connector integration with Identity Governance Agent."""
...
class ThreatIntelConnector:
    """Domain-specific connector for threat intel integration with Identity Governance Agent."""
...
class TicketingSystemConnector:
    """Domain-specific connector for ticketing system integration with Identity Governance Agent."""
