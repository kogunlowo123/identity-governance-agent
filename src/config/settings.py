"""Application configuration for Identity Governance Agent."""
...
class Settings(BaseSettings):
    ...
    app_name: str = Field(default="identity-governance-agent", description="Application name")
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/identity_governance_agent",
    ...
    opensearch_index: str = Field(default="identity_governance_agent_vectors", description="Index")
    ...
    mcp_server_name: str = Field(default="identity-governance-agent-mcp", description="MCP server name")

    a2a_discovery_url: str = Field(default="http://localhost:8500", description="A2A discovery URL")
    a2a_agent_id: str = Field(default="identity-governance-agent", description="A2A agent ID")
